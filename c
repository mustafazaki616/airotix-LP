...
const PrivacyPolicy = () => {
  ...
  return (
    <PageLayout>
      <section className="pt-8 pb-16 px-5 sm:px-6 lg:px-[35px]">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            <Link
              to="/"
              className="inline-flex items-center text-[#A8A8A8] hover:text-white mb-6 transition-colors"
            >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-[#A8A8A8] mb-6">Last updated: April 11, 2025</p>

              <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">1. Introduction</h2>
              <p className="text-[#A8A8A8] mb-4">
                At AIROTIX Technologies ("we," "our," or "us"), we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
              ...
              <ul className="list-disc pl-6 mb-4 text-[#A8A8A8]">
              ...
              <p className="text-[#A8A8A8] mb-4">If you have any questions about this Privacy Policy, please contact us at airotix@gmail.com</p>
            </div>
          </div>
        </div>
      </section>
