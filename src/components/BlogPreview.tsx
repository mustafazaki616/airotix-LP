...
const BlogPreview = () => {
  ...
  return (
    <section id="blog" className="py-12 md:py-24 px-4 md:px-12 bg-black">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Newspaper size={20} className="text-[#cf4500]" />
              <span className="text-[#cf4500] font-medium">Our Blog</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Latest Updates</h2>
            <p className="text-gray-300 max-w-xl">
              Explore our latest insights on smart textile technology, industry trends, and innovation.
            </p>
          </div>
          <Link to="/blog" className="mt-4 md:mt-0">
            <Button variant="outline" className="group border-[#cf4500] text-[#cf4500] hover:bg-[#cf4500] hover:text-white">
              View All Posts
